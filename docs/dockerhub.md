...
<img src="https://github.com/Jumacasni/Terrake/blob/hito3/docs/img/dockerhub1.png" width="60%" height="60%">

2. Se ha renombrado la imagen a ``jumacasni/terrake:latest`` y se ha subido usando ``docker push jumacasni/terrake``.

<img src="https://github.com/Jumacasni/Terrake/blob/hito3/docs/img/dockerhub2.png" width="60%" height="60%">
...
<img src="https://github.com/Jumacasni/Terrake/blob/hito3/docs/img/dockerhub3.png" width="60%" height="60%">

2. En la pestaña de **Builds** del contenedor subido se ha configurado la actualización automática.

<img src="https://github.com/Jumacasni/Terrake/blob/hito3/docs/img/dockerhub4.png" width="60%" height="60%">
...
<img src="https://github.com/Jumacasni/Terrake/blob/hito3/docs/img/dockerhub5.png" width="60%" height="60%">